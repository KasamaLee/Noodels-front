...
export default function Modal({ children, isOpenModal, onCloseModal, z = 'z-30' }) {

    return (
        <>
            {isOpenModal && (
                <>
                    <div className={`${z} fixed top-0 bottom-0 right-0 left-0 backdrop-blur-sm flex justify-center items-center`}>
